...
@Database(
    entities = [
        WorkoutEntity::class, ExerciseEntity::class, ChallengeDayEntity::class,
        MealEntity::class, MealNutrientEntity::class, MealFilterEntity::class, FilterItemEntity::class
    ],
    version = 1
)
